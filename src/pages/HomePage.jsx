...
class HomePage extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            introPosts: [{imgLink:"http://localhost:8080/api/tws/resource/images/nhansuphuonglan",text:"Đội ngũ chuyên nghiệp", title:"Nhân Sự Hust", link:"/intro"},
                        {imgLink:"http://localhost:8080/api/tws/resource/images/cuoihoidep",text:"Bộ sưu tập", title:"Cưới hỏi đẹp RHUST", link:"/collections/all"},
