...
class CollectionsAll extends Component {
	...
	componentDidMount(){
		TwsService.getAllProducts().then(res=>{
								...
								<div class="row card-group padding">
									{
										this.state.allProducts.map(product =>
											<div class="col-md-3">
												<div class="card zoom" style={{marginBottom: '1rem'}}>
													<a href={"/collections/detail/"+product.id}>
													...
													<div class="card-body d-flex align-items-end">
														<h6 style={{color: "black"}} class="card-title">{product.title}</h6>
													</div>
													</a>
												</div>
											</div>
