        ...
        return (
            <div class="main">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Trang trí tiệc cưới hoa tươi/hoa lụa</li>
                    </ol>
                </nav>
                
                <div>
                    <img src ="http://localhost:8080/api/tws/resource/theme/4"></img>
                </div>
				<hr/>
                <div class="container-fluid">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div className="box-sidebar block">
								...
								<li class="">
									<span></span>
									<a class="" href="/collections/be-le-chuyen-nghiep" title="" target="_self">
										Bê lễ chuyên nghiệp HUST
									</a>
								</li>						
							    </ul>
                                </div>
                        ...
                        <div class="wrap-collection-title row">
						        <div class="heading-collection row">
							        <div class="col-md-8 col-sm-12 col-xs-12">
								        <h1 class="title">Trang trí hoa tươi/hoa lụa tại nhà hàng, khách sạn</h1>
